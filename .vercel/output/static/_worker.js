...
Try changing the value to '${Math.ceil(eo2.revalidate)}' or using \`Math.ceil()\` if you're computing the value.`);
      ...
      function np(e10) {
        let { data: t10 } = e10;
        return t10 ? (0, nh.jsx)("div", { style: { marginLeft: 50, marginTop: 50 }, children: t10.resultados[0].id }) : null;
      }
      async function nf(e10) {
        let t10 = await fetch("https://api-dev.infoimoveis.com.br/imoveis/"), r10 = await t10.json();
        return { props: { data: r10 } };
      }
      var nm = r(764);
